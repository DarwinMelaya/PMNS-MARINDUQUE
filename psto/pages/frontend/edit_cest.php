...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- SELECT2 EXAMPLE -->
            <form action="../backend/update_cest.php" method="get">
                <div class="card card-success">
                    ...
                    <input type="text" name="project_id" id="project_id" value="<?= $_GET['id'] ?>" hidden>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date_approved" value="<?= $date_approved ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" value="<?= $duration_from ?>" name="duration_from" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Duration To</label>
                                    <input type="date" name="duration_to" value="<?= $duration_to ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row">
