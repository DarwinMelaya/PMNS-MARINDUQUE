                ...
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="project_code" class="form-control" placeholder="Enter Project Code" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Description<span style="color:red; font-size: 12px;">(Note: Max character 250)</span></label>
                                    <textarea name="desc" id="desc" rows="3" maxlength="250" class="form-control" placeholder="Enter Description"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="ps" id="ps" min="0" class="form-control" onchange="amtofassist()" placeholder="0" step="0.01">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Maintenance and Other Expenses</label>
                                    <input type="number" name="moe" id="moe" min="0" class="form-control" onchange="amtofassist()" placeholder="0" step="0.01">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Equipment Outlay</label>
                                    <input type="number" name="eo" id="eo" min="0" class="form-control" onchange="amtofassist()" placeholder="0" step="0.01">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="aoa" id="aoa" min="0" class="form-control" placeholder="0" onchange="addnum()" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="cpf" id="cpf" min="0" class="form-control" onchange="addnum()" placeholder="0" step="0.01">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="totalprojcost" id="totalprojcost" placeholder="0" class="form-control" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row">
