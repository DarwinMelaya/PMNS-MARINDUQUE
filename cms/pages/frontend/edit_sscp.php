...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <form action="../backend/update_sscp.php" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="prog_desc" id="desc" rows="3" class="form-control" maxlength="350" placeholder="Enter program Description" name="project_desc" style="width: 100%;" required><?php echo stripslashes($row['project_desc']); ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
