            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control" name="tag" type="text" placeholder="Enter Project tag" style="width: 100%;" value="<?= $tag ?>" required>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="project_type" data-placeholder="Select Project Type" style="width: 100%;" required>
                    ...
                    if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
                        echo '<option value="' . $row["prj_type_id"] . '"';
                        if ($project_type == $row['prj_type_id']) {
                          echo 'selected';
                        }
                        echo '>' . $row["prj_type_name"] . '</option>';
                      }
                    }
                    $conn->close();
                    ?>
                  ...
                  <select class="select2" name="collaborating_agencies" multiple="multiple" data-placeholder="Select Collaborating Agencies" style="width: 100%;">
                    ...
                    if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
                        ...
                        if ($collaborating_agencies == $row['col_id']) {
                          echo 'selected';
                        }
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="status" style="width: 100%;" data-placeholder="Select Project Status" required>
                    ...
                    if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
                        echo '<option value="' . $row["prj_status_id"] . '"';
                        if ($status == $row['prj_status_id']) {
                          echo 'selected';
                        }
                        echo '>' . $row["prj_status_name"] . '</option>';
                      }
                    }
                    $conn->close();
                    ?>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control" name="beneficiary_counterpart" type="number" max="99999999" step="0.01" placeholder="Enter Beneficiaries’ Counterpart" value="<?= $beneficiary_counterpart ?>" style="width: 100%;">
                </div>
                <!-- /.form-group -->
              </div>
              <div class="col-md-4">
