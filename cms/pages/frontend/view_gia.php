                                ...
                                <div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                                    ...
                                    <table id="example3" class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            ?><tr>
                                                        <td><a href="../../../uploads/<?= $row['filename'] ?>.<?= $row['type'] ?>" target="popup" onclick="window.open('../../../uploads/<?= $row['filename'] ?>.<?= $row['type'] ?>','popup','width=600,height=600'); return false;"><?= $row['temp_filename'] ?></a></td>
