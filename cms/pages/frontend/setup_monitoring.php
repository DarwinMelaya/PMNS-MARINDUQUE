...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>SETUP Projects</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">SETUP Projects Monitoring</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <?php
                ...
                $sql = "select * from projects where project_type = '2' AND province='$province'";
                  ...
                  <tr>
                      ...
                      <td class="project_progress">
                        ...
                        ?>
                          ...
                          <small>
                              <?= $totalUploads ?> out of 28 uploaded
                          </small>
                        <?php
                                }
                        ?>
                      ...
                      <div class="btn-group" role="group">
                        ...
                        <a class="btn btn-primary btn-sm" href="view_project_setup.php?id=<?= $row['project_id'] ?>" title="View to Upload Progress Reports">
