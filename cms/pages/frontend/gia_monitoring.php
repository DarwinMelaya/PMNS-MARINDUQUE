            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">GIA Projects Monitoring</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <table id="example3" class="table table-striped projects">
                    ...
                    <tbody>
                        ...
                        if ($_SESSION['level'] == 1 || $_SESSION['level'] == 0) {
                            $sql = "select * from projects where project_type = '1'";
                        } else {
                            $sql = "select * from projects where project_type = '1' AND province = '$province'";
                        }
                        ...
                        ?>
                                ...
                                <small>No Uploaded Progress Report</small>';
                                    ...
                                    <td><a class="btn btn-warning btn-sm" href="#" title="View Physical Documents" onclick="showModal('<?= $row['project_id'] ?>')">
                                ...
                                <small>No Uploaded Progress Report</small>';
                                    ...
                                    <td>
                                        <a class="btn btn-warning btn-sm" href="#" title="View Financial Documents" onclick="showModal('<?= $row['project_id'] ?>')">
                                            <i class="fas fa-folder-open"></i>
                                        </a>
                                    </td>
                                    <td class="project_progress">
                                    ...
                                    <td class="project-actions text-right">
                                        <div class="btn-group" role="group">
                                            ...
                                            <a class="btn btn-primary btn-sm" href="view_project_gia.php?id=<?= $row['project_id'] ?>" title="View to Upload Progress Reports">
