...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <form action="../backend/update_gia.php" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="barangay" name="barangay" placeholder="Enter Barangay" style="width: 100%;" value="<?php echo stripslashes($row['barangay']); ?>">
                                </div>
                                <!-- /.form-group -->
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="street" class="form-control" placeholder="Enter Street Address" value="<?php echo stripslashes($row['street']); ?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="prog_desc" id="desc" rows="3" class="form-control" maxlength="1000" placeholder="Enter program Description" name="project_desc" style="width: 100%;" required><?php echo stripslashes($row['project_desc']); ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="proponent" class="form-control" placeholder="Enter Proponent" value="<?php echo stripslashes($row['proponent']); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Collaborating Agency</label>
                                    <input type="text" id="collab" name="collab" placeholder="Enter Collaborating Agency" class="form-control" value="<?php echo stripslashes($row['collaborating_agencies']); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="beneficiaries" id="beneficiaries" placeholder="Enter beneficiaries" class="form-control" value="<?php echo stripslashes($row['beneficiaries']); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
