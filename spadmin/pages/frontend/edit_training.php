          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-9">
                <div class="form-group">
                  <label>Tag *</label>
                  <input class="form-control" name="tag" type="text" placeholder="Enter Forum/Training/Seminar tag" style="width: 100%;" value="<?= $tag ?>" required>
                </div>
                <!-- /.form-group -->
              </div>
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="training_type" style="width: 100%;" data-placeholder="Select Training Type" required>
                    ...
                    if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
                        echo '<option value="' . $row["fr_type_id"] . '"';
                        if ($training_type == $row['fr_type_id']) {
                          echo 'selected';
                        }
                        echo '>' . $row["fr_type_name"] . '</option>';
                      }
                    }
                    $conn->close();
                    ?>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select class="select2" name="service_provider" data-placeholder="Select Service Provider" style="width: 100%;">
                    ...
                    if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
                        echo '<option value="' . $row["sp_id"] . '"';
                        if ($service_provider == $row['sp_id']) {
                          echo 'selected';
                        }
                        echo '>' . $row["sp_name"] . '</option>';
                      }
                    }
                    $conn->close();
                    ?>
                  ...
                  <select class="form-control select2" name="sectors" style="width: 100%;" data-placeholder="Select Sector" required>
                    ...
                    if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
                        ...
                        if ($sectors == $row['sector_id']) {
                          echo 'selected';
                        }
                        echo '>' . $row["sector_name"] . '</option>';
                      }
                    }
                    $conn->close();
                    ?>
                  ...
                  <select class="form-control select2" name="implementor" style="width: 100%;" data-placeholder="Select Implementor" required>
                    ...
                    if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
                        ...
                        if ($implementor == $row['implementor_id']) {
                          echo 'selected';
                        }
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control" name="male_participants" type="number" max="99999999" value="<?= $male_participants ?>" placeholder="Enter No. of Male Participants" style="width: 100%;">
                </div>
                <!-- /.form-group -->
              </div>
              <div class="col-md-4">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control" name="firm_participants" type="number" max="99999999" value="<?= $firm_participants ?>" placeholder="Enter Total No. of Participating Firms" style="width: 100%;">
                </div>
                <!-- /.form-group -->
              </div>
              <div class="col-md-4">
