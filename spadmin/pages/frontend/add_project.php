            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control" name="tag" type="text" placeholder="Enter Tag" style="width: 100%;" required>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control" name="beneficiary_counterpart" type="number" max="99999999" step="0.01" placeholder="Enter Beneficiaries’ Counterpart" style="width: 100%;">
                </div>
                <!-- /.form-group -->
              </div>
              <div class="col-md-4">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select name="" id="" class="form-control select2" data-placeholder="Enter District" style="width: 100%;"></select>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="city_mun" id="city_mun" data-placeholder="Select City/Municipality" style="width: 100%;">
                    ...
                    include '../../connection/connection.php';
                    $sql = "SELECT * FROM citymun where region_c = 17";
                    $result = $conn->query($sql);
                    if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
